  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-mesh p-4">
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-blue-500/08 rounded-full blur-3xl" />
      </div>
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-display font-bold text-3xl text-[rgb(var(--text-primary))]">Create account</h1>
          <p className="text-[rgb(var(--text-muted))] mt-1 text-sm">Start your fitness journey today</p>
        </div>
